...
/**
 * @constructor Menu
 * @description Create Main Menu for player selection.
 * This screen will show up in the beginning, and every time the player losses.
 */
var Menu = function () {
    this.message = ['Welcome to Frogger!', 'Select your Character to continue'];
    this.selected = false;
    this.x = 130;
    this.y = 200;
};
...
/**
 * @constructor Lives
 * @description This section is used to create the Lives object.
...
/**
 * @constructor Score
 * @description This section is used to create the Score object.
...
/**
 * @constructor Enemy
 * @description This section is used to define the Enemy object with all
 ...
 * @param {int} speed - The speed of the enemy. Suggested values 1-3 (and everything inbetween)z
 */
...
Enemy.prototype.collision = function () {
    if (player.x <= this.x + 80 && player.x >= this.x - 70 && player.y === this.y) {
        return true;
    }
};
...
/**
 * @constructor Player
 * @description This section is used to define the Player object with all
...
document.addEventListener('keyup', function (e) {
    ...
    //Check if the key is being pressed in main menu, or in the game
    if (menu.selected) {
