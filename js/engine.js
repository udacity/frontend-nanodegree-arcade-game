...
var Engine = (function(global) {
    ...
    function update(dt) {
      updateEntities(dt);
      gameSpace.checkGemCollision(allGems,player,scoreBoard);
      gameSpace.checkEnemyCollision(allEnemies,player,allHearts);
      gameSpace.checkGameOver(timer, gameOverScreen, highScore, scoreBoard);
      gameSpace.checkPlayerAtWater(player,scoreBoard, highScore);
    }
    ...
    function updateEntities(dt) {
      ...
      timer.update(pauseScreen.pauseMode);
    }
    ...
    /*This function is for rendering for objects on the gameplay*/
